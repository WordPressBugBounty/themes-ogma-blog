...
jQuery(document).ready(function($) {
    ...
    $('.mt-action-btn').click(function(){
        ...
        switch(actionBtnStatus){
            case 'install':
                ogma_blog_do_free_plugin( 'ogma_blog_install_free_plugin', pluginSlug, _this );
                break;

            case 'active':
                ogma_blog_do_free_plugin( 'ogma_blog_activate_free_plugin', pluginSlug, _this );
                break;
        }

    });

    ogma_blog_do_free_plugin = function ( ajax_action, pluginSlug, _this ) {
        $.ajax({
            method : "POST",
            url : WpAjaxurl,
            data : ({
