...
class Ogma_Blog_Notice {
    ...
    public function __construct() {
        ...
        add_action( 'wp_ajax_ogma_blog_install_free_plugin', array( $admin_main_class, 'ogma_blog_install_free_plugin' ) );
        add_action( 'wp_ajax_ogma_blog_activate_free_plugin', array( $admin_main_class, 'ogma_blog_activate_free_plugin' ) );
